...
# Documentos al dia - Feature #53: check_no_se_cuelga_por_stdin

Contesta CADA bloque con uno de los tres veredictos y despues corre
`sh harness_cli prd apply --feature 53`:
...
Presente en: docs/prd/PRD-master.md:1 (spec `master`), docs/prd/PRD-master.md:1 (spec `nombre`), docs/prd/PRD-master.md:108 (spec `dispara`) y 154 más
Ausente en: -
Candidato despues:
...
Presente en: docs/prd/SDD-master.md:1 (spec `master`), docs/prd/SDD-master.md:100 (spec `llamada`), docs/prd/SDD-master.md:101 (spec `decision`) y 119 más
Ausente en: -
Candidato despues:
- Cambio de la feature en: `harness_check.sh`, `templates/harness_check.sh`, `tests/commit_guard_stdin_check.sh`. Revisa si este documento debe reflejarlo.
...
Presente en: docs/architecture.md:102 (spec `camino`), docs/architecture.md:105 (spec `fuente`), docs/architecture.md:106 (spec `estructura`) y 237 más
Ausente en: -
Candidato despues:
- Cambio de la feature en: `harness_check.sh`, `templates/harness_check.sh`, `tests/commit_guard_stdin_check.sh`. Revisa si este documento debe reflejarlo.
