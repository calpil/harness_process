...
- #81 consolidar: la declaracion mutua en relacionadas no alcanza sola para confianza 1.00 -> done 2026-09-07 · spec: docs/spec-feature-81-consolidar-la-declaracion-mutua-en-relacionadas-.md · impl: docs/impl-81.md
- #84 leccion partir: parte una leccion sobre el tope a referencias/ con informe y --aplicar, reconoce las secciones por feature en sus formas reales, y el check resume en una linea las lecciones sobre el tope -> done 2026-09-08 · spec: docs/spec-feature-84-leccion-partir-parte-una-leccion-sobre-el-tope-a.md · impl: docs/impl-84.md
- #85 Copilot CLI como backend de primera clase: superficie .github/copilot-instructions.md, hooks en .github/copilot.json, agentes en .github/agents, fila en doctor y backend LLM en la tabla de CLIs -> done 2026-09-10 · spec: docs/spec-feature-85-copilot-cli-como-backend-de-primera-clase-superf.md · impl: docs/impl-85.md
- #86 Copilot medido en vivo: los hooks van por el .claude/settings.json que el arnes ya genera (sin .github/copilot.json), el Stop de los dos runtimes emite decision:block, y doctor revisa la confianza de la carpeta -> done 2026-09-10 · spec: docs/spec-feature-86-copilot-medido-en-vivo-los-hooks-van-por-el-clau.md · impl: docs/impl-86.md
